    ...
    public static void main(String args[]){
      ...
      switch (prgnumber){
          ...
          case 7:{
              ...
              AryCommon ac=new AryCommon();
              ac.commonString();
              ac.CommonIntegers();
          }
          case 8:{
              //program 8 Remove Duplicate from the Array
              RmvDuplicate re=new RmvDuplicate();
              re.rmvduplicate();
          }
          case 9:{
              //program 9 Number of Odd and Even Number in the array
              OddEvenIntegers oei=new OddEvenIntegers();
              oei.findOddEven();
          }
          case 10:{
          ...
          case 13:{
              //Program 13 splite even and odd value in array and add odd first elements and then even elements
